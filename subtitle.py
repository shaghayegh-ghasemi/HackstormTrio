            ...
            if start_time <= current_time <= end_time:
                ...
                for word in words:
                    ...
                    if text_size[0] > max_width:
                        ...
                        line = test_line
                lines.append(line)
                text_height = (cv2.getTextSize("A", cv2.FONT_HERSHEY_SIMPLEX, font_scale, thickness)[0][1] + 10) * len(
                    lines)
...
def main(gdrive_url):
    """
    Main function to process the video: download, transcribe, generate subtitles, overlay them, and ensure audio is retained.
    """
